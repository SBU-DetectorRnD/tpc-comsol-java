...
import com.comsol.model.util.*;
	...
	public int FSENumber = 60; // Number of strips on both inner and outer, total strip number=2*(FSENumber+FSENumber-1) 
	...
	public void makeTerminals(){
		...
		this.model.physics("current").selection().set(new int[] {1,2,4,6,9,249,251}); //used to be {1,2,4,6,8,2*FSENumber+10,2*FSENumber+12}; Domain Selection of electric current physics
	...
	public void setMaterials(){
		...
		this.makeAir(new int[] {1,2,4,6,9,249,251}); //old: {1,2,4,6,8,2*FSENumber+10,2*FSENumber+12} Changes chosen domains from copper to air.
		}
